            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="/cart.php" class="btn btn-warning navbar-btn">
                            ...
                            if (isset($_COOKIE['cart'])) {
                                $cartCount = count(explode('/', $_COOKIE['cart']));
                                echo "($cartCount)";
                            }
                    ...
                    <?php if (isset($_SESSION['userName'])) {
                        echo '<li><a class="btn btn-danger" href="logout.php" role="button">Logout</a></li>';
                    } else {
                        echo '<li><a class="btn btn-success" href="login.php" role="button">Login</a></li>';
                    }
                    ?>
                </ul>
            </div><!-- /.navbar-collapse -->
